...
module LamportDelivery
  ...
  bloom :lamport do
    ...
    cloq <+ pipe_in {|c| cloq + 1}
    cloq <+ pipe_out {|c| cloq + 1}
...
(1..3).each do |i|
  alice.async_do do
    alice.pipe_in <+ [["localhost:23456", "localhost:12345", 1, "Bob, you're a palindrome!", alice.cloq.current_value]]
  end
  sleep 1
  bob.async_do do
    bob.pipe_in <+ [["localhost:12345", "localhost:23456", 1, "You can't spell malice without Alice", bob.cloq.current_value]]
  end
  sleep 1
end
sleep 1