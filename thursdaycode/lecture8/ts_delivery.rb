...
module TSDeliveryProtocol
  state do
    ...
    # @param [Object] cloq is the message timestamp
    # @return [pipe_sent] when the tuple we inserted appears in :pipe_sent, delivery is successful
    interface input, :pipe_in, [:dst, :src, :ident] => [:payload, :cloq]
    ...
    # @param [Object] payload is the message payload
    # @param [Object] cloq is the message timestamp
    interface output, :pipe_sent, [:dst, :src, :ident] => [:payload, :cloq]
    ...
    # @param [Object] payload is the message payload
    # @param [Object] cloq is the message timestamp
    interface output, :pipe_out, [:dst, :src, :ident] => [:payload, :cloq]
  end
